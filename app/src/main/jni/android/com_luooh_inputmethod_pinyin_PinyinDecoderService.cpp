...
//    LOG_FATAL_IF(gFileDescriptorOffsets.mDescriptor == NULL, "Unable to find descriptor field in java.io.FileDescriptor");
...
static int registerNatives(JNIEnv *env) {
    if (!registerNativeMethods(env,
                               "com/luooh/inputmethod/pinyin/PinyinDecoderService",
